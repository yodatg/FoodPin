...
//  FoodPin
//
//  Created by Tom Grant on 23/10/2018.
...
class RestaurantTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, leadingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let checkinAction = UIContextualAction(style: .normal, title: "Checkin") {(action, sourceView, completionHandler) in
            
            let cell = tableView.cellForRow(at: indexPath) as! RestaurantTableViewCell
            
            // Check into restauraunt
        ...
        // set image based on restaurant status
        if self.restaurantIsVisited[indexPath.row] == false {
            checkinAction.backgroundColor = UIColor(red: 38.0/255.0, green: 194.0/255.0, blue: 129/255.0, alpha: 1.0)
            checkinAction.image = UIImage(named: "tick")
        }
        else {
            checkinAction.backgroundColor = UIColor(red: 254.0/255.0, green: 149.0/255.0, blue: 38.0/255.0, alpha: 1.0)
